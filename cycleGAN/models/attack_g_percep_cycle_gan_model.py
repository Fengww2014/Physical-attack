...
class AttackGPercepCycleGANModel(BaseModel):
    """
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_ATTACK', type=float, default=0.0, help='weight for ATTACK loss for adversarial attack in fake B')
        return parser
    ...
    def backward_G(self):
        ...
        #ATTACK loss
        if lambda_att > 0 :
            self.loss_G_ATTACK = (self.criterionATTACK(self.fake_B) + self.criterionATTACK(self.rec_A) + self.criterionATTACK(self.rec_B)) * lambda_att
        else:
